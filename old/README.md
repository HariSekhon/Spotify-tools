...
##### These tools are obsolete and superceded by a whole suited of Spotify tools in this repo and the [DevOps Bash tools](https://github.com/HariSekhon/DevOps-Bash-tools) repo.

These programs are named after the old Spotify API endpoints
