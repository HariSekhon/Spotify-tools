...
# Alpine / Wget:
#
# wget https://raw.githubusercontent.com/HariSekhon/spotify-tools/master/setup/bootstrap.sh && sh bootstrap.sh
#
# Curl:
#
# curl https://raw.githubusercontent.com/HariSekhon/spotify-tools/master/setup/bootstrap.sh | sh

set -eu
[ -n "${DEBUG:-}" ] && set -x
srcdir="$(dirname "$0")"

repo="https://github.com/HariSekhon/spotify-tools"

directory="spotify-tools"
